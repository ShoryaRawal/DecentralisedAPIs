...
import { idlFactory } from './stable_diffusion_ic.did.js';
export { idlFactory } from './stable_diffusion_ic.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_STABLE_DIFFUSION_IC;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./stable_diffusion_ic.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the stable_diffusion_ic canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./stable_diffusion_ic.did.js")._SERVICE>}
 */
export const stable_diffusion_ic = createActor(canisterId);
